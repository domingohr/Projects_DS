...
data = pd.read_csv ('historical_automobile_sales.csv')# ('https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-DV0101EN-SkillsNetwork/Data%20Files/historical_automobile_sales.csv')
...
app.layout = html.Div([
    ...
    html.Div([#TASK 2.2: Add two dropdown menus
        ...
        dcc.Dropdown(
            ...
            style={'width': '80%', 'padding': 3, 'textAlign': 'center', 'fontSize': 20}
        )
    ]),
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        ...
        R_chart4 = dcc.Graph(
            figure=px.bar(unemp_rate,
                ...
                y='Automobile_Sales',
                color='Vehicle_Type',
                title="Unemployment Rate on Automobile Sales by Vehicle Type during Recession Period"))
